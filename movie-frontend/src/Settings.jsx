            ...
            <AnimatePresence mode="wait">
              {activeTab === 'account' ? (
                ...
                >
                  ...
                  <div className="bg-[#121212]/50 backdrop-blur-xl border border-white/5 p-8 rounded-[2.5rem] shadow-2xl relative overflow-visible">
                  ...
                  <div className="bg-[#121212]/50 backdrop-blur-xl border border-white/5 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
                    <div className="flex justify-between items-center mb-6">
                      ...
                      {!isChangingPwd && (
                        <button 
                          ...
                          className="px-5 py-2 bg-white/5 hover:bg-white/10 text-white font-bold rounded-xl transition-colors border border-white/10 flex items-center gap-2 text-sm"
                        >
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between pt-2">
                            <div className="text-sm font-bold">
                              {pwdMessage.text && (
                                <span className={`flex items-center gap-2 ${pwdMessage.type === 'success' ? 'text-green-500' : 'text-red-500'}`}>
                            ...
                            <div className="flex gap-3">
                              ...
                              <button 
                                ...
                                className="flex items-center gap-2 px-6 py-2.5 bg-red-600 hover:bg-red-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-red-600/30 disabled:opacity-50"
                              >
                    ...
                    <form onSubmit={searchUserByEmail} className="flex flex-col sm:flex-row gap-4 relative">
                      <div className="flex-1 relative">
                        ...
                        <input 
                          ...
                          required
                          className="w-full bg-black/40 border border-white/10 text-white rounded-xl py-3.5 pl-12 pr-4 focus:outline-none focus:border-red-600 focus:bg-white/5 transition-all text-sm shadow-inner"
                        />
                      </div>
                      <button 
                        type="submit" 
                        disabled={isSearchingUser} 
                        className="px-8 py-3.5 bg-red-600 hover:bg-red-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-red-600/30 disabled:opacity-50 shrink-0"
                      >
                        {isSearchingUser ? <Loader2 className="w-5 h-5 animate-spin" /> : "Search"}
                      </button>
                    </form>

                    {friendMessage.text && (
                      <div className={`mt-4 text-sm font-bold flex items-center gap-2 ${friendMessage.type === 'success' ? 'text-green-500' : 'text-red-500'}`}>
        ...
        {unfriendConfirm.show && (
          ...
          >
            ...
            <motion.div
              ...
              className="bg-[#1a1a1a] border border-white/10 rounded-3xl p-6 w-full max-w-sm shadow-[0_20px_50px_rgba(0,0,0,0.8)] flex flex-col gap-4"
            >
              ...
              <div className="flex justify-end gap-3 mt-4 pt-4 border-t border-white/5">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl text-sm font-bold bg-red-600 hover:bg-red-500 text-white transition-colors shadow-lg shadow-red-600/30 flex items-center gap-2"
                >
  ...
  return (
    <div className="relative overflow-visible">
      ...
      <input
        ...
        readOnly={readOnly}
        className={`w-full bg-transparent border text-white rounded-xl py-3.5 pl-4 ${type === 'password' ? 'pr-12' : 'pr-4'} focus:outline-none transition-all text-sm shadow-inner placeholder:text-transparent ${
          readOnly 
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      <div
        ...
        className={`w-full bg-black/40 border text-white rounded-xl py-3.5 px-4 flex items-center justify-between cursor-pointer transition-all text-sm shadow-inner ${
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {options.length === 0 ? (
              <li className="px-4 py-3 text-sm text-gray-500 italic">No devices found</li>
            ) : (
              options.map((opt) => (
                <li
                  key={opt.deviceId}
